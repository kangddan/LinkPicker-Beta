...
class PickerMenu(QtWidgets.QMenu):
    ...
    def _createActions(self):
        ...
        self.addCommandButtonAction  = Action(QtGui.QIcon('linkPickerIcons:pythonLogo2.png'), 'Add Command Button (Beta)',  self)
        self.alignHorizontallyAction = Action(QtGui.QIcon('linkPickerIcons:alignHorizontallyIcon.png'), 'Align Buttons Horizontally', self)
        self.alignVerticallyAction   = Action(QtGui.QIcon('linkPickerIcons:alignVerticallyIcon.png'), 'Align Buttons Vertically',  self)
